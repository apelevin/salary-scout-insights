...
export const NAME_COLUMN_ALIASES = [
...
export const SALARY_COLUMN_ALIASES = [
...
export const ROLE_PARTICIPANT_ALIASES = [
...
export const FTE_COLUMN_ALIASES = [
...
export const CIRCLE_NAME_ALIASES = [
  'название', 'название круга', 'круг', 'circle', 'circle name', 'наименование круга'
];
